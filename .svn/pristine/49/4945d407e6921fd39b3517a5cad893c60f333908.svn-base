...
#define COLOR_DELETE UIColorFromHex(0xF73042)
...
typedef void (^NormalBlock2)(int index, id item);
...
#define API_MONITOR_ALARM_DETAIL @"mobile/alarm_monitor/alarm_detail"
...
//巡检
#define API_CHECK_LIST @"mobile/patrol_mission_list"
#define API_CHECK_START @"mobile/patrol_mission_start"



#define API_CHECK_SAVE @"mobile/patrol_mission_submit_ios"
#define API_PARTOL_USERLIST @"mobile/patrol_assignUser_list"
#define API_CHECK_DETAIL @"mobile/station_check_location_list"
#define API_setCheckMissionTrail @"mobile/patrol_mission_trail_api"
...
//巡检点管理
#define API_patrol_location_list @"mobile/patrol_location_list"
#define API_patrol_location_delete @"mobile/patrol_location_delete"
#define API_patrol_location_device_list @"mobile/patrol_location_device_list"




#define API_COMM_STATION_LIST @"mobile/sta_list"
...
#define API_ALARMSNEW_LIST @"mobile/alarm_monitor/alarm_list"

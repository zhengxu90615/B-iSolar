...
- (void)setData:(NSDictionary *)data andButtonClick:(nonnull NormalBlock)blcok{
    ...
    label1.text = data[@"endTime"];
    label2.text = data[@"appointUser"];
    label3.text = data[@"assigneeUser"];
    label4.text = data[@"missionStatusName"];
    ...
    int cancelButton = [data[@"button_dict"][@"cancelButton"] intValue];
